package de.demo.micro.web.rest;

import de.demo.micro.MicroserviceDemoApp;
...
import de.demo.micro.web.rest.errors.ExceptionTranslator;
...
import static de.demo.micro.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = MicroserviceDemoApp.class)
public class ImageResourceIntTest {
    ...
    public void createImage() throws Exception {
        ...
        assertThat(testImage.getValidFrom()).isEqualTo(DEFAULT_VALID_FROM);
        assertThat(testImage.getValidTo()).isEqualTo(DEFAULT_VALID_TO);
    }
    ...
    public void updateImage() throws Exception {
        ...
        assertThat(testImage.getValidFrom()).isEqualTo(UPDATED_VALID_FROM);
        assertThat(testImage.getValidTo()).isEqualTo(UPDATED_VALID_TO);
    }
